    ...
    <div class="sticky-table">
        <table v-if="loaded" class="table table-striped table-bordered planning-table">
            ...
            <tr>
                ...
                <th class="w-20 left-header-sticky text-center align-middle">Projects</th>
            ...
            <template v-for="(stateProjects, state) in groupedProjects" :key="state">
                ...
                <tr v-for="project in stateProjects">
                    ...
                    <td class="left_sticky l-200 w-8 align-middle cell-p text-center heading-tech-total">{{ table[project.id]['total'] }}</td>
